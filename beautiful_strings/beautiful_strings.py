...
When John was a little kid he didn't have much to do. There was 
no internet, no Facebook, and no programs to hack on. So he did 
the only thing he could... he evaluated the beauty of strings in 
a quest to discover the most beautiful string in the world. 
...
def total_beauty(line):
    count_letters = collections.Counter(mod_line)
    common_letters = count_letters.most_common()
    weight = 26
    total = 0
...
if __name__ == '__main__':
    ...
    for line in file_obj:
        mod_line = str(line).strip().lower()
        mod_line = mod_line.replace(" ", "")
        
        print total_beauty(mod_line)
